@ -5,11 +5,77 @@ import { useRouter } from "next/navigation";
...
@ -17,18 +83,81 @@ export default function OnboardingFlow() {
...
@ -63,13 +192,26 @@ export default function OnboardingFlow() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f7f5f0] to-[#dfe9e3] px-6 py-10 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-xl">
        ...
        <motion.div
          ...
          animate={{
@ -86,10 +228,7 @@ export default function OnboardingFlow() {
          }}
        />
        ...
        <div className="relative border border-white/40 rounded-[36px] p-6 bg-white/60 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.08)]">
          ...
          <div className="flex items-center justify-between">
            <button
              onClick={back}
@ -112,135 +251,357 @@ export default function OnboardingFlow() {
            {current.required ? (
              <div className="w-10" />
            ) : (
